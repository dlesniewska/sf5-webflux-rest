...
public class VendorControllerTest {
    ...
    public void list() {
        given(vendorRepository.findAll())
                .willReturn(Flux.just(Vendor.builder().firstName("SomeName1").lastName("SomeLastname1").build(),
                        Vendor.builder().firstName("SomeName2").lastName("SomeLastname2").build()));
    ...
    public void getById() {
        given(vendorRepository.findById("someid"))
                .willReturn(Mono.just(Vendor.builder().firstName("SomeName").lastName("SomeLastname").build()));
    ...
    public void testCreate() {
        given(vendorRepository.saveAll(any(Publisher.class)))
                .willReturn(Flux.just(Vendor.builder().firstName("Some firstname").lastName("Some lastname").build()));
    ...
    public void testUpdate() {
        ...
        Mono<Vendor> vendorToUpdateMono = Mono.just(Vendor.builder().firstName("Some firstname").lastName("Some lastname").build());
